...
# This implementation defines a Generator and a Discriminator using Transformer-based architectures.
# The Generator synthesizes time series data, while the Discriminator evaluates its authenticity.
# Both models leverage self-attention mechanisms for sequence modeling.
...
class Generator(nn.Module):
    def __init__(
        ...
        self.l1 = nn.Linear(
            self.latent_dim + self.label_embed_dim, self.seq_len * self.data_embed_dim
        )
...
class PatchEmbedding_Linear(nn.Module):
    def __init__(self, in_channels=21, patch_size=16, emb_size=100, seq_length=1024):
        ...
        self.positions = nn.Parameter(
            torch.randn((seq_length // patch_size) + 1, emb_size)
        )
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            Dis_TransformerEncoder(
                depth, emb_size=data_emb_size, drop_p=0.5, forward_drop_p=0.5, **kwargs
            ),
